...
export const ACTION_PERMISSION_REQUIREMENTS = {
  ...
  generateRuleQualityReports: { allOf: ['generate_rule_quality_reports'] },
  ...
  modifyFeatures: { allOf: ['modify_features'] },
...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  generate_rule_quality_reports: 'Generate rule quality reports',
