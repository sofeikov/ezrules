...
If you plan to run the main lane in strict sequence, see [Ordered Rule Execution in ezrules](https://ezrules.io/blog/rule-ordering-first-match/) for when first-match mode is useful and how the platform applies it.
